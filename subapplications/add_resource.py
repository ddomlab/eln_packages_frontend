...
class Add_Resource_Window(tk.Frame):
    ...
    def fill_info(self, event=None):
        cas_entry = self.cas_entry.get()# select type of resource
    def submit(self):
        pass
...
def main():
    ...
    Add_Resource_Window(scroll_area.scrollable_frame).pack(side="top", fill="both", expand=True)
